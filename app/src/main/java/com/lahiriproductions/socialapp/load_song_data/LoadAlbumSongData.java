...
public class LoadAlbumSongData {


    public static ArrayList<SongsModelData> getSongsForAlbum(Context context, long albumID) {
    ...
    public static Cursor makeAlbumSongCursor(Context context, long albumID) {
        ...
        final String albumSongSortOrder = PreferencesData.getInstance(context).getAlbumSongSortOrder();
